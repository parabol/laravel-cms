...
{{ Form::model($test, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('tests.update', $test->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('tests.show', 'Cancel', $test->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
